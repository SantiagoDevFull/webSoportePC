<%-- 
    Document   : pagNuevaBoleta
    Created on : 19 jul. 2023, 16:59:36
    Author     : usuario
--%>
    ...
    <head>
        ...
        <br>
            <div class="container mt-3">
                ...
                <h4>::: Nueva Boleta N° ${txtCodigoBol} :::</h4>
            <hr>

            <form action="ControlBoleta" method="POST" onsubmit="return ValidarProceso()">
                <input type="hidden" name="txtIDboleta" value="${txtCodigoBol}">
                ...
                <div id="carrito" class="mt-3">
                    <jsp:include page="../Vista/pagDetalleBoleta.jsp"></jsp:include>
                    </div>
            ...
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    ...
                    <div class="modal-body" id="producto">
                        <jsp:include page="../Vista/pagProductosBoleta.jsp"></jsp:include>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
                    </div>
